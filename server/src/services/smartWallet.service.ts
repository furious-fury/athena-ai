...
export class SmartWalletService {
    ...
    static async sendTransaction(
        ...
        try {
            const privateKey = ownerPrivateKey as Hex;
            const signer = privateKeyToAccount(privateKey);
     ...
     */
    static async getSmartAccountClient(ownerPrivateKey: string) {
        const privateKey = ownerPrivateKey as Hex;
        const signer = privateKeyToAccount(privateKey);
        ...
        (client as any).originalOwner = signer;
     ...
     */
    static async getUSDCTransfers(toAddress: Address, fromBlock?: bigint) {
        try {
